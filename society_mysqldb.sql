...
CREATE TABLE `society` (
  `society_id` int DEFAULT '' not null,
...
--
ALTER TABLE `basic_maintenance_bill`
  MODIFY `bill_num` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `flat`
  MODIFY `flat_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `resident`
  MODIFY `resident_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `society`
--
ALTER TABLE `society`
  MODIFY `society_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `wing`
--
ALTER TABLE `wing`
  MODIFY `wing_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
